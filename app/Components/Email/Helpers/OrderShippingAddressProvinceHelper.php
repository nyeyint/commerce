...
class OrderShippingAddressProvinceHelper
{
    ...
    protected function parse()
    {
        ...
        if (array_key_exists('order', $this->data)) {
            ...
            $this->parsed = is_array($this->helper)
                                                    ?  str_replace($this->helper['helper'], $address_data->province_label, $string)
                                                    :  str_replace($this->helper, $address_data->province_label, $string);
