...
class OrderShippingEstimatedDeliveryHelper
{
    ...
    protected function parse()
    {
        ...
        if (array_key_exists('order', $this->data)) {
            ...
            $this->parsed = is_array($this->helper)
                                                    ?  str_replace($this->helper['helper'], $courier_data->cost['etd'] . ' days', $string)
                                                    :  str_replace($this->helper, $courier_data->cost['etd'] . ' days', $string);
