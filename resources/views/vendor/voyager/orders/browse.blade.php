                                ...
                                <tbody>
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                ...
                                                @elseif($row->type == 'checkbox')
                                                    ...
                                                    @if($row->field == 'user_id')
                                                        {{ user($data->{$row->field})->name }} ({{ user($data->{$row->field})->email }})
                                                    @elseif($row->field == 'status')
                                                        {!! to_label($data->{$row->field}) !!}
                                                    @elseif($row->field == 'total')
                                                        {{ _rupiah($data->{$row->field}) }}
                                                    @elseif($row->field == 'quantity')
                                                        {{ $data->{$row->field} }} Items.
                                                    @else
                                                        {{ $data->{$row->field} }}
                                                    @endif
                                        ...
                                        <td class="no-sort no-click" id="bread-actions">
                                                ...
                                                <a href="/admin/orders/{{$data->id}}/details" title="Details" class="btn btn-sm btn-warning">
                                                    <i class="voyager-eye"></i> <span class="hidden-xs hidden-sm">Details</span>
                                                </a>

                                                @if($data->status == 'waiting shipment')
                                                    <a href="/admin/orders/{{$data->id}}/ship" title="Ship!" class="btn btn-sm btn-success">
                                                        <i class="voyager-paper-plane"></i> <span class="hidden-xs hidden-sm">Ship!</span>
                                                    </a>
                                                @elseif($data->status == 'waiting confirmation')
                                                    <a href="/admin/orders/{{$data->id}}/approve" title="Approve" class="btn btn-sm btn-success">
                                                        <i class="voyager-check"></i> <span class="hidden-xs hidden-sm">Approve</span>
                                                    </a>
                                                @elseif($data->status == 'shipped')
                                                    <a href="/admin/orders/{{$data->id}}/archive" title="Archive" class="btn btn-sm btn-success">
                                                        <i class="voyager-archive"></i> <span class="hidden-xs hidden-sm">Archive</span>
                                                    </a>
                                                @endif
