                                        ...
                                        @else
                                            @if($row->field == 'weight')
                                                <div class="input-group input-group-xs">
                                                    <input data-name="{{$row->display_name}}" class="form-control" name="{{$row->field}}" placeholder="{{$row->display_name}}" value="" type="{{$row->type}}">
                                                    <span class="input-group-addon" id="sizing-addon1">Gram</span>
                                                </div>
                                            @else
...
@section('javascript')
    <script>
        ...
        $('document').ready(function () {
            ...
            // Hide & show the discount text
            $('input[name=is_discount]').change(function() {
                $('#product_discount_percent').toggle($(this).prop('checked'));
            });
